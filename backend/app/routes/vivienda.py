...
@router.get("/usuarios", response_model=List[Usuario], operation_id="get_users")
async def get_users(service: UsuarioService = Depends(get_usuario_service)):
    return await service.get_usuarios()

@router.get("/usuarios/{id}", response_model=Usuario, operation_id="get_user_by_id")
...
@router.post("/usuarios", response_model=Usuario, operation_id="new_user")
...
@router.delete("/usuarios/{id}", operation_id="delete_user")
...
@router.put("/usuarios/{id}", response_model=Usuario, operation_id="edit_user")
